...
fail=0
required=(README.md LICENSE VERSION install.sh uninstall.sh update.sh toolkitctl lib/common.sh lib/core.sh lib/backup.sh lib/wordpress.sh lib/security.sh lib/mail.sh lib/ssl.sh lib/monitoring.sh lib/dashboard.sh dashboard/app.py)
